...
use refeff_io::{
    ...
    DmdwOutHeader, DmdwOutSection, DmdwOutSubject, DmdwOutTemperature, EelsDatData, EmeshBinData,
    EmeshDatData, EpsDatData, ExcDatData, FeffBinData, FeffBinPath, FeffBinPotential, FeffDocument,
    FeffInput, FmsBinData, Fort16Data, HamakerDatData, JzzpDatData, LdosDatData, ListDatData,
    ...
    read_jzzp_dat, read_ldos_dat, read_list_dat, read_mdff_dat, read_misc_dat, read_module_log_dat,
    read_mpse_dat, read_opcons_dat, read_osc_str_dat, read_paths_dat, read_phase_bin,
    read_prexmu_dat, read_residue_dat, read_rhorrp_density_text, read_rhozzp_dat, read_rixs_map,
    read_sumrules_dat, read_vtot_dat, read_wscrn_dat, read_xmu_dat, read_xscorr_raw_dat,
    read_xsect_dat, write_apot_bin, write_bandstructure_dat, write_chi_dat, write_contour_dat,
    ...
    write_eps_dat, write_exc_dat, write_feff_bin, write_fms_bin, write_fort16, write_hamaker_dat,
    write_jzzp_dat, write_ldos_dat, write_list_dat, write_mdff_dat, write_misc_dat,
    write_module_log_dat, write_mpse_dat, write_osc_str_dat, write_paths_dat, write_phase_bin,
    write_pot_bin, write_prexmu_dat, write_residue_dat, write_rhorrp_density_text,
    write_rhozzp_dat, write_rixs_map, write_vtot_dat, write_wscrn_dat, write_xmu_dat,
...
fn apot_matrix_section(section_number: usize, header: &str, values: Array2<f64>) -> ApotBinSection {
    ApotBinSection {
        section_number,
