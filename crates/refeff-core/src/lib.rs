...
pub use fullspectrum::{
    ...
    FullSpectrumDrudeInput, FullSpectrumDrudeTerm, FullSpectrumEdgeAssembly,
    FullSpectrumEdgeAssemblyInput, FullSpectrumEdgeGrid, FullSpectrumEdgeGridInput,
    FullSpectrumEdgeSelection, FullSpectrumEdgeSelectionInput, FullSpectrumError,
    ...
    FullSpectrumOpticalConstants, FullSpectrumOpticalConstantsInput, FullSpectrumQSumInput,
...
pub use xsph::{
    ...
    XsphLjSpectrumUpdateInput, XsphRelativisticMultipoleFactors, XsphSortedEnergyGrid,
    XsphSpectrumUpdateMode, XsphXanesEnergyGrid84, xsph_angular_density_coefficients, xsph_axafs,
