...
pub use sfconv::{
    ...
    SfconvSpectralWeightsInput, SfconvXanesConvolution, SfconvXanesConvolutionInput,
    ...
    sfconv_exafs_convolution, sfconv_exponential_reduction, sfconv_extrinsic_beta,
    sfconv_extrinsic_satellite, sfconv_extrinsic_satellite_broadened,
