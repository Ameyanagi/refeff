...
pub use atomic::{
    ...
    AtomicDiracNodeCount, AtomicDiracNodeCountInput, AtomicDiracNormalization,
    AtomicDiracNormalizationInput, AtomicDiracSolutionNormalization,
    ...
    atomic_dirac_solver_setup, atomic_direct_coulomb_coefficient,
