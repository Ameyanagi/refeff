...
mod tests {
    ...
    use super::{
        ...
        FullSpectrumBackgroundInput, FullSpectrumBackgroundSegmentInput,
        ...
        full_spectrum_default_energy_grid, full_spectrum_drude_term,
    ...
    #[test]
    fn default_energy_grid_prefers_fine_structure_edges_like_feff_rdop()
    -> Result<(), FullSpectrumError> {
