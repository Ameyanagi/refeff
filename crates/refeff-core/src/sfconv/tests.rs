...
use super::{
    ...
    SfconvSo2convSelfEnergySampleInput, SfconvSo2convSpecfunctInput,
    SfconvSo2convXanesPreparationInput, SfconvSpectralCellInput, SfconvSpectralEnergyGrid,
    SfconvSpectralFinalizationInput, SfconvSpectralInterpolationInput, SfconvSpectralTableInput,
