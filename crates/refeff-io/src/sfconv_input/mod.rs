...
pub use target_data::{
    ...
    sfconv_so2conv_feff_path_data_from_averages, sfconv_so2conv_target_data_from_text,
    sfconv_so2conv_target_data_string, sfconv_so2conv_xmu_data_from_convolution_rows,
    write_sfconv_so2conv_convoluted_target_data, write_sfconv_so2conv_target_data,
};
