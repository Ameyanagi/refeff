...
pub use specfunct_dat::{
    ...
    SfconvSpecfunctExafsRowsInput, SfconvSpecfunctXanesRowsInput, SfconvSpecfunctXmuDataInput,
    parse_specfunct_dat, read_specfunct_dat, sfconv_specfunct_exafs_convolution_rows,
