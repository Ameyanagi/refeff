...
pub use specfunct_dat::{
    ...
    parse_specfunct_dat, read_specfunct_dat, sfconv_specfunct_chi_data_from_cache,
    ...
    sfconv_specfunct_momentum_interpolation_input, sfconv_specfunct_target_data_from_cache,
    sfconv_specfunct_xanes_convolution_rows, sfconv_specfunct_xmu_data_from_cache,
