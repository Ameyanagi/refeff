...
- Core numerical helpers ported from FEFF common routines, including radial
  ...
  heap helpers, standard-frame and canonical time-reversal path coordinates,
  path pruning criteria and decisions, output-path importance, companion-index
  sorting, and state-ket construction.
