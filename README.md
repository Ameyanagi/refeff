...
- Core numerical helpers ported from FEFF common routines, including radial
  grids, Dirac spinor and potential/density grid interpolation, atomic
  weight/symbol/mass lookup, phase unwrapping, core-hole widths/quantum
  numbers, vector rotations, Legendre normalization tables, Wigner 3j
  coefficients, exchange-potential,
