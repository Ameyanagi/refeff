...
- Core numerical helpers ported from FEFF common routines, including radial
  ...
  FEFF spherical-overlap cap/lens volumes and muffin-tin overlap-matrix
  construction, Norman-radius integration from overlapped densities, FEFF
  potential/density overlap assembly, Coulomb-potential correction, valence
  density and LDOS accumulation, Broyden SCF density mixing, interstitial shell
  averages, four-point Coulomb radial integration, interstitial Fermi-level
  calculation, overlap-density tail indexing,
