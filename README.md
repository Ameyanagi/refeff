...
- Initial RHORRP density-grid traversal/evaluation, `density.inp` Bohr-grid
  ...
  terms, point-pair energy-density assembly, energy prefactors,
  energy-density finishing, and Fermi-contour integration helpers,
...
- FEFF RHORRP `gg_slice.bin` and `gg_diag.bin` sequential unformatted FMS
  matrix handoff read/write and core-ready block extraction support.
