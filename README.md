...
- Initial SFCONV numerical helpers for FEFF `mkrmu` Kramers-Kronig real-part
  ...
  satellite spectral-function helpers, `senergies.f90` beta and real
  self-energy primitives, `interpsf.f90` spectral-function interpolation,
  and `sfconvsub.f90` spectral-function convolution.
