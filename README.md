...
- Core numerical helpers ported from FEFF common routines, including radial
  ...
  Norman-radius integration from overlapped densities, interstitial shell
  averages, interstitial Fermi-level calculation, overlap-density tail
  indexing, atomic weight/symbol/mass lookup, phase
